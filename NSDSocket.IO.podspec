...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/NeeSDev/NSDSocket.IO.git", :tag => "#{s.version}" }
  ...
  #NSDSocket.IO
  s.subspec 'NSDSocket.IO' do |ss|
    ss.public_header_files = 'NSDSocket.IO.h'
    ss.source_files = 'NSDSocket.IO.h'

    ss.subspec 'Socket.IO' do |sss|
